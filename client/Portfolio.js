    ...
    <div className="contentBox">
      <div className="section">
        ...
        <div className="pictureBox">
          <img src="/screenShots/tetris/tetrisMenu.png" alt="Menu" />
          <img src="/screenShots/tetris/tetrisGameplay.png" alt="Gameplay" />
          <img src="/screenShots/tetris/tetrisGameplay2.png" alt="Late game" />
          <img src="/screenShots/tetris/tetrisGameover.png" alt="Game over" />
      ...
      <div className="section">
        ...
        <p>Work-In-Progress: A two player turn-based game combining mechanics of Chess and Soccer.</p>
        <p>ROLE: Creator</p>
      </div>
      ...
      <div className="section">
        ...
        <p>ROLE: Programmed battle logic and designed GUIs</p>
      ...
      <div className="section">
        <h2>Walker Talker | <small><a href="https://github.com/ZacharyDudley/walk-and-talk-2">git repository</a></small></h2>
          <p>An experiment in streaming real-time audio over the internet</p>
          <p>ROLE: Developer</p>
      </div>
